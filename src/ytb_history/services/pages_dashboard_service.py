...
CSV_TABLE_SPECS: tuple[tuple[str, str], ...] = (
    ...
    ("latest_predictions", "predictions/latest_predictions.csv"),
    ("latest_hybrid_recommendations", "model_intelligence/latest_hybrid_recommendations.csv"),
...
JSON_FILE_SPECS: tuple[tuple[str, str], ...] = (
    ...
    ("prediction_summary", "predictions/prediction_summary.json"),
    ("model_intelligence_summary", "model_intelligence/model_intelligence_summary.json"),
